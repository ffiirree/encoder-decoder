...
__all__ = ['AutoEncoderWidthTwoDecoder']
...
class AutoEncoderWidthTwoDecoder(nn.Module):
...
if __name__ == "__main__":
    model = AutoEncoderWidthTwoDecoder(3, 1, 3)

    # print(model)

    x = torch.rand([1, 3, 512, 512])

    masks, reimages = model(x)
    print(masks.shape, reimages.shape)
